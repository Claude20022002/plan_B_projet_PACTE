...
- Name: app.spec.cjs >> 🔐 Authentification >> champs email et mot de passe vides → bouton désactivé ou erreur visible
- Location: tests\app.spec.cjs:58:5
...
Locator: locator('[role="alert"], .MuiAlert-root, .MuiFormHelperText-root')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[role="alert"], .MuiAlert-root, .MuiFormHelperText-root')
      ...
      - generic [ref=e18]:
        - generic [ref=e19]:
          - generic [ref=e20]:
            ...
            - generic [ref=e21]: "*"
          - generic [ref=e22]:
            - textbox "Nom d'utilisateur ou mail" [active] [ref=e23]
            - group:
        ...
        - generic [ref=e34]:
          - generic [ref=e35] [cursor=pointer]:
            - generic [ref=e36]:
              - checkbox "Se rappeler de moi" [ref=e37]
              - img [ref=e38]
            - generic [ref=e40]: Se rappeler de moi
          - generic [ref=e41]: Mot de passe oublié ?
        - button "Connexion" [ref=e43] [cursor=pointer]: Connexion
```
